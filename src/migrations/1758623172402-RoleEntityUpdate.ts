...
export class RoleEntityUpdate1758623172402 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "auth_users" ADD CONSTRAINT "FK_b9a6f5e2eb8d3372d2158cbd96f" FOREIGN KEY ("role_id") REFERENCES "roles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
